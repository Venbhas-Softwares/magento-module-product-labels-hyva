...
class GalleryPlugin
{
    ...
    public function afterToHtml(Gallery $subject, string $result): string
    {
        ...
        return '<div class="vp-label-wrappe">'
            . $result
            . $labelsHtml
            . '</div>';
    }
